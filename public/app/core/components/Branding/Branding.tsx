...
const LoginLogo: FC<BrandComponentProps & { logo?: string }> = ({ className, logo }) => {
  return <img className={className} src={`${logo ? logo : grafanaIconSvg}`} alt="RadarOS" />;
};
...
const MenuLogo: FC<BrandComponentProps> = ({ className }) => {
  return <img className={className} src={grafanaIconSvg} alt="RadarOS" />;
};
...
export class Branding {
  ...
  static AppTitle = 'RadarOS';
  static LoginTitle = 'RadarOS';
